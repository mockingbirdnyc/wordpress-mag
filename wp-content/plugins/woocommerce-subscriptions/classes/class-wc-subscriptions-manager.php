	...
	public static function get_subscription( $subscription_key, $deprecated = null ) {
		...
		if ( ! empty( $item ) ) {
			...
			$subscription = array(
				...
				'period'             => isset( $item['subscription_period'] ) ? $item['subscription_period'] : WC_Subscriptions_Product::get_period( $item['product_id'] ),
				'interval'           => isset( $item['subscription_interval'] ) ? $item['subscription_interval'] : WC_Subscriptions_Product::get_interval( $item['product_id'] ),
				'length'             => isset( $item['subscription_length'] ) ? $item['subscription_length'] : WC_Subscriptions_Product::get_length( $item['product_id'] ),
