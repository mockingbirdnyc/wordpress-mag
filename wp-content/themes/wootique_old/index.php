...
?>
	...
	<div id="featured-products" class="<?php if ( get_option( 'woo_featured_product_style' ) == 'slider' ) { echo 'fp-slider'; } ?>">
		<h2><?php _e( 'Subscription Options', 'woothemes' ); ?></h2>
			...
			<li class="flipper">
					...
					<div class="front">
						...
						<?php woocommerce_show_product_sale_flash( $post, $_product ); ?>
							...
							<?php if ( has_post_thumbnail( $loop->post->ID ) ) echo get_the_post_thumbnail( $loop->post->ID, 'thumbnail' ); else echo '<img src="' . $woocommerce->plugin_url() . '/assets/images/placeholder.png" alt="Placeholder" width="' . wc_get_image_size( 'thumbnail_width' ) . 'px" height="' . wc_get_image_size( 'thumbnail_height' ) . 'px" />'; ?>
							</a>
