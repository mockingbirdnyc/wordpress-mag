<?php get_header(); ?>
	...
	<?php if ( wootique_get_woo_option( 'woo_breadcrumbs_show' ) == 'true' ) { ?>
		<?php woo_breadcrumbs(); ?> 
	<?php } ?>
    ...
    <div id="content" class="col-full">
        ...
        <?php while (have_posts()) : the_post(); $count++; ?>
			...
			<div <?php post_class(); ?>>
                ...
                <?php if ( wootique_get_woo_option( 'woo_thumb_single' ) == "true" && !woo_embed( '')) woo_image( 'width='. wootique_get_woo_option( 'woo_single_w' ) .'&height='. wootique_get_woo_option( 'woo_single_h' ) .'&class=thumbnail '. wootique_get_woo_option( 'woo_thumb_single_align' ) ); ?>
				...
				<?php if ( wootique_get_woo_option( 'woo_post_author' ) == "true" ) { ?>
				<div id="post-author">
            ...
            <?php $comm = wootique_get_woo_option( 'woo_comments' ); if ( ($comm == "post" || $comm == "both") ) : ?>
