    ...
    <div id="content" class="col-full">
        ...
        <?php while (have_posts()) : the_post(); $count++; ?>
            ...
            <div <?php post_class(); ?>>
                ...
                <div class="entry">
                    <?php if ( wootique_get_woo_option( 'woo_post_content' ) == "content" ) the_content(__( 'Read More...', 'woothemes' )); else the_excerpt(); ?>
                </div><!-- /.entry -->

                <div class="post-more">      
					<?php if ( wootique_get_woo_option( 'woo_post_content' ) == "excerpt" ) { ?>
