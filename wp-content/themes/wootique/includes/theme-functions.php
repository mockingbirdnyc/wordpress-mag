...
?>
	<?php if ( wootique_get_woo_option( 'woo_connect' ) == "true" OR $widget == 'true' ) : ?>
	<div id="connect">
		...
		<div <?php if ( $related_posts != '' ) echo 'class="col-left"'; ?>>
			<p><?php if ( wootique_get_woo_option( 'woo_connect_content' ) != '') echo stripslashes( wootique_get_woo_option( 'woo_connect_content' ) ); else _e( 'Subscribe to our e-mail newsletter to receive updates.', 'woothemes' ); ?></p>

			<?php if ( wootique_get_woo_option( 'woo_connect_newsletter_id' ) != "" AND $form != 'on' ) : ?>
			<form class="newsletter-form<?php if ( $related_posts == '' ) echo ' fl'; ?>" action="http://feedburner.google.com/fb/a/mailverify" method="post" target="popupwindow" onsubmit="window.open( 'http://feedburner.google.com/fb/a/mailverify?uri=<?php echo wootique_get_woo_option( 'woo_connect_newsletter_id' ); ?>', 'popupwindow', 'scrollbars=yes,width=550,height=520' );return true">
				...
				<input type="hidden" value="<?php echo wootique_get_woo_option( 'woo_connect_newsletter_id' ); ?>" name="uri"/>
			...
			<?php if ( wootique_get_woo_option( 'woo_connect_mailchimp_list_url' ) != "" AND $form != 'on' AND wootique_get_woo_option( 'woo_connect_newsletter_id' ) == "" ) : ?>
			<!-- Begin MailChimp Signup Form -->
			<div id="mc_embed_signup">
				<form class="newsletter-form<?php if ( $related_posts == '' ) echo ' fl'; ?>" action="<?php echo wootique_get_woo_option( 'woo_connect_mailchimp_list_url' ); ?>" method="post" target="popupwindow" onsubmit="window.open('<?php echo wootique_get_woo_option( 'woo_connect_mailchimp_list_url' ); ?>', 'popupwindow', 'scrollbars=yes,width=650,height=520');return true">
			...
			<?php if ( $social != 'on' ) : ?>
			<div class="social<?php if ( $related_posts == '' AND wootique_get_woo_option( 'woo_connect_newsletter_id' ) != "" ) echo ' fr'; ?>">
				<?php if ( wootique_get_woo_option( 'woo_connect_rss' ) == "true" ) { ?>
				<a href="<?php if ( wootique_get_woo_option( 'woo_feed_url' ) ) { echo esc_url( wootique_get_woo_option( 'woo_feed_url' ) ); } else { echo get_bloginfo_rss('rss2_url'); } ?>" class="subscribe"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-rss.png" title="<?php _e('Subscribe to our RSS feed', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_twitter' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_twitter' ) ); ?>" class="twitter"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-twitter.png" title="<?php _e('Follow us on Twitter', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_facebook' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_facebook' ) ); ?>" class="facebook"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-facebook.png" title="<?php _e('Connect on Facebook', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_youtube' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_youtube' ) ); ?>" class="youtube"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-youtube.png" title="<?php _e('Watch on YouTube', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_flickr' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_flickr' ) ); ?>" class="flickr"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-flickr.png" title="<?php _e('See photos on Flickr', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_linkedin' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_linkedin' ) ); ?>" class="linkedin"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-linkedin.png" title="<?php _e('Connect on LinkedIn', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_delicious' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_delicious' ) ); ?>" class="delicious"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-delicious.png" title="<?php _e('Discover on Delicious', 'woothemes'); ?>" alt=""/></a>

				<?php } if ( wootique_get_woo_option( 'woo_connect_googleplus' ) != "" ) { ?>
				<a href="<?php echo esc_url( wootique_get_woo_option( 'woo_connect_googleplus' ) ); ?>" class="googleplus"><img src="<?php echo get_template_directory_uri(); ?>/images/ico-social-googleplus.png" title="<?php _e('View Google+ profile', 'woothemes'); ?>" alt=""/></a>
		...
		<?php if ( wootique_get_woo_option( 'woo_connect_related' ) == "true" AND $related_posts != '' ) : ?>
...
if ( ! function_exists( 'wootique_get_woo_option' ) ) {
	function wootique_get_woo_option( $key ) {
		global $woo_options;
		return array_key_exists( $key, $woo_options ) ? $woo_options[ $key ] : false;
	}
}
/*-----------------------------------------------------------------------------------*/
/* END */
